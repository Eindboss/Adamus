...
def main():
    ...
    folder = os.environ.get("ADAMUS_BIO_H4_PATH")
    if not env_path or not folder:
        raise SystemExit("Set ADAMUS_ENV_PATH and ADAMUS_BIO_H4_PATH.")
    ...
    subject_sql = (
        ...
        "values ('Biologie', 'Hoofdstuk 4: Stevigheid en beweging') "
    ...
    material_select_sql = (
        ...
        "where source_uri = 'local://vakken/biologie-h4' "
        "limit 1;"
    )
    ...
    if material_select_res:
        ...
        material_sql = (
            ...
            "values ("
            f"'{subject_id}', '4', null, 'Biologie hoofdstuk 4 (scans)', "
            "'image', 'local://vakken/biologie-h4', "
