...
## Testresultaten v3.6 (Biologie Quiz - 48 vragen)
...
- Cache geldig voor: 24-48 uur
- Cache ook "slechte" URLs
- Bestandsformaat: JSON file (simpel) of SQLite (robuuster)
...
*Testresultaten toegevoegd op basis van biologie quiz run*
